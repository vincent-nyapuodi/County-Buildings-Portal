...
public class PublicCommentAdapter extends FirebaseRecyclerAdapter<PublicComments, PublicCommentAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public PublicCommentAdapter(@NonNull @NotNull FirebaseRecyclerOptions<PublicComments> options, Context context) {
        super(options);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        PublicCommentAdapter.MyViewHolder myViewHolder = new PublicCommentAdapter.MyViewHolder(view);
